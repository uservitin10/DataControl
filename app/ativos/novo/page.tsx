  ...
  return (
    <main className="gov-page-bg min-h-screen">
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <PageHeader title={<h1 className="text-3xl font-bold text-gov-heading">Novo ativo</h1>} subtitle="Preencha os dados do ativo para incluir no levantamento." backHref="/levantamento" />

        <div className="rounded-[2rem] border border-slate-200/80 bg-white p-6 shadow-[0_20px_50px_-30px_rgba(15,23,42,0.18)] sm:p-8">
          <AtivoForm profiles={profiles} areas={areas} action={criarAtivoAction} />
        </div>
      </div>
    </main>
  );
